  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-6 gap-y-6 gap-x-3 w-full max-w-5xl justify-items-center">
        {/* Contact Info Card */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-6 sm:p-8 flex flex-col w-full max-w-md hover:scale-[1.03] transition-transform duration-300">
      ...
      {/* Buttons */}
      <div className="mt-10 flex flex-col md:flex-row items-center gap-4 justify-center w-full max-w-3xl">
        <a
          href="https://wa.me/96181090757"
          className="px-6 py-3 bg-[#25D366] text-white font-semibold rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition transform flex items-center gap-2 justify-center min-w-[180px]"
        >
        ...
        <a
          ...
          className="px-6 py-3 bg-[#3A5487] text-white font-semibold rounded-2xl shadow-lg hover:shadow-2xl hover:scale-105 transition transform flex items-center gap-2 justify-center min-w-[180px]"
        >
          Send Email
        </a>
      </div>
